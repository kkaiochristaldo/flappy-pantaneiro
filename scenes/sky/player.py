...
class SkyPlayer(Entity):
    def __init__(self, player_cfg: dict):
        ...
        self.is_alive = True
        self.invincible = False # O escudo é controlado pela cena agora
    ...
    def __process_physics(self, delta_time: float):
        ...
        if self.__is_thrusting:
            current_acceleration -= self.__thrust_accel
    ...
    def activate_shield(self, active: bool):
        """Ativa ou desativa o estado de invencibilidade."""
